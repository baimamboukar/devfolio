<script setup>
  // Define props for hackathons data
  ...
  <section class="mb-12">
    ...
    <div class="space-y-6">
      ...
      >
        ...
        />
        <UCard class="bg-gray-50 dark:bg-gray-900/50 cursor-pointer">
          <div class="relative">
            <nuxt-img
              :src="hackathon.icon"
              :alt="hackathon.name"
              width="100"
              height="100"
              sizes="200px sm:100px md:150px"
              placeholder="[50, 25, 75, 5]"
              class="absolute bg-white dark:bg-gray-800 rounded-lg"
            />
