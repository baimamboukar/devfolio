...
<template>
  <nuxt-link
    class="relative flex items-center justify-start w-full px-4 py-2 transition-colors duration-150 focus-visible:global-focus card-style rounded-xl hover:bg-sky-50/25 dark:hover:bg-zinc-700/75"
    :to="url"
    :title="problemTitle"
  >
    <div
