...
cover_image: https://raw.githubusercontent.com/baimamboukar/portfolio/main/public/content/cover/http-requests-in-javascript.png
canonical_url: https://baimamboukar.dev/blog/http-requests-in-javascript
...
Fetch is a promise-based web API. It is a modern alternative to XHR. I have explained in detail how the `fetch()` API works [here](https://baimamboukar.dev/blog/the-javascript-fetch-api). But let's redo the previous requests using fetch and see the difference.
