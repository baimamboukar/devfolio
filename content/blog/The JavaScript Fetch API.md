...
cover_image: https://raw.githubusercontent.com/baimamboukar/portfolio/main/public/content/cover/the-javascript-fetch-api.png
canonical_url: https://baimamboukar.dev/blog/the-javascript-fetch-api
published_on: "2023-10-25"
---

One of the ways of making [HTTP requests in JavaScript](https://baimamboukar.dev/blog/http-requests-in-javascript) is the `fetch()` API. The `fetch()` API is a modern JavaScript API that allows web developers to send/retrieve data across the web.
